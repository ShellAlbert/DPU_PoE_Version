...
if(!iRstN) begin
    ...
    if(iEn) begin
        case(iIndex)
            ...
            1:begin {oRegAddr,oRegData}<={OV5640_SYSTEM_CTROL0, 8'h82}; end //0x3008=0x82.
            2:begin {oRegAddr,oRegData}<={OV5640_SCCB_SYSTEM_CTRL1, 8'h03}; end //0x3103=0x03.
            3:begin {oRegAddr,oRegData}<={16'h3630, 8'h36}; end //0x3630=0x36.
            4:begin {oRegAddr,oRegData}<={16'h3631, 8'h0e}; end //0x3631=0x0e.
            5:begin {oRegAddr,oRegData}<={16'h3632, 8'he2}; end //0x3632=0xe2.
            6:begin {oRegAddr,oRegData}<={16'h3633, 8'h12}; end //0x3633=0x12.
            7:begin {oRegAddr,oRegData}<={16'h3621, 8'he0}; end //0x3621=0xe0.
            8:begin {oRegAddr,oRegData}<={16'h3704, 8'ha0}; end //0x3704=0xa0.
            9:begin {oRegAddr,oRegData}<={16'h3703, 8'h5a}; end //0x3703=0x5a.
            10:begin {oRegAddr,oRegData}<={16'h3715, 8'h78}; end //0x3715, 0x78,
            11:begin {oRegAddr,oRegData}<={16'h3717, 8'h01}; end //0x3717, 0x01,
            12:begin {oRegAddr,oRegData}<={16'h370b, 8'h60}; end // 0x370b, 0x60,
            13:begin {oRegAddr,oRegData}<={16'h3705, 8'h1a}; end //0x3705, 0x1a,
            14:begin {oRegAddr,oRegData}<={16'h3905, 8'h02}; end //0x3905, 0x02,
            15:begin {oRegAddr,oRegData}<={16'h3906, 8'h10}; end //0x3906, 0x10,
            16:begin {oRegAddr,oRegData}<={16'h3901, 8'h0a}; end //0x3901, 0x0a,
            17:begin {oRegAddr,oRegData}<={16'h3731, 8'h12}; end //0x3731, 0x12,
            18:begin {oRegAddr,oRegData}<={16'h3600, 8'h08}; end //0x3600, 0x08, // VCM control
            19:begin {oRegAddr,oRegData}<={16'h3601, 8'h33}; end //0x3601, 0x33, // VCM control
            20:begin {oRegAddr,oRegData}<={16'h302d, 8'h60}; end //0x302d, 0x60, // system control
            21:begin {oRegAddr,oRegData}<={16'h3620, 8'h52}; end //0x3620, 0x52,
            22:begin {oRegAddr,oRegData}<={16'h371b, 8'h20}; end //0x371b, 0x20,
            23:begin {oRegAddr,oRegData}<={16'h471c, 8'h50}; end // 0x471c, 0x50,
            24:begin {oRegAddr,oRegData}<={OV5640_AEC_CTRL13, 8'h43}; end // 0x3a13, 0x43, // pre-gain = 1.047x
            25:begin {oRegAddr,oRegData}<={OV5640_AEC_GAIN_CEILING_HIGH, 8'h00}; end // 0x3a18, 0x00, // gain ceiling
            26:begin {oRegAddr,oRegData}<={OV5640_AEC_GAIN_CEILING_LOW, 8'hf8}; end // 0x3a19, 0xf8, // gain ceiling = 15.5x
            27:begin {oRegAddr,oRegData}<={16'h3635, 8'h13}; end // 0x3635, 0x13,
            28:begin {oRegAddr,oRegData}<={16'h3636, 8'h03}; end //0x3636, 0x03,
            29:begin {oRegAddr,oRegData}<={16'h3634, 8'h40}; end //0x3634, 0x40,
            30:begin {oRegAddr,oRegData}<={16'h3622, 8'h01}; end //0x3622, 0x01,
            //// 50/60Hz detection 50/60Hz 
            31:begin {oRegAddr,oRegData}<={OV5640_5060HZ_CTRL01, 8'h34}; end //0x3c01, 0x34, // Band auto, bit[7]
            32:begin {oRegAddr,oRegData}<={OV5640_5060HZ_CTRL04, 8'h28}; end // 0x3c04, 0x28, // threshold low sum
            33:begin {oRegAddr,oRegData}<={OV5640_5060HZ_CTRL05, 8'h98}; end // 0x3c05, 0x98, // threshold high sum
            34:begin {oRegAddr,oRegData}<={OV5640_LIGHTMETER1_TH_HIGH, 8'h00}; end //0x3c06, 0x00, // light meter 1 threshold[15:8]
            35:begin {oRegAddr,oRegData}<={OV5640_LIGHTMETER1_TH_LOW, 8'h00}; end //0x3c07, 0x08, // light meter 1 threshold[7:0]
            36:begin {oRegAddr,oRegData}<={OV5640_LIGHTMETER2_TH_HIGH, 8'h00}; end // 0x3c08, 0x00, // light meter 2 threshold[15:8]
            37:begin {oRegAddr,oRegData}<={OV5640_LIGHTMETER2_TH_LOW, 8'h1c}; end //0x3c09, 0x1c, // light meter 2 threshold[7:0]
            38:begin {oRegAddr,oRegData}<={OV5640_SAMPLE_NUMBER_HIGH, 8'h9c}; end //0x3c0a, 0x9c, // sample number[15:8]
            39:begin {oRegAddr,oRegData}<={OV5640_SAMPLE_NUMBER_LOW, 8'h40}; end // 0x3c0b, 0x40, // sample number[7:0]
            ...
            60:begin {oRegAddr,oRegData}<={OV5640_TIMING_HOFFSET_HIGH, 8'h00}; end //0x3810, 0x00, // Timing Hoffset[11:8]
            61:begin {oRegAddr,oRegData}<={OV5640_TIMING_HOFFSET_LOW, 8'h10}; end //0x3811, 0x10, // Timing Hoffset[7:0]
            62:begin {oRegAddr,oRegData}<={OV5640_TIMING_VOFFSET_HIGH, 8'h00}; end //0x3812, 0x00, // Timing Voffset[10:8]
            63:begin {oRegAddr,oRegData}<={OV5640_TIMING_VOFFSET_LOW, 8'h06}; end //0x3813, 0x06, // timing V offset   
            64:begin {oRegAddr,oRegData}<={16'h3618, 8'h00}; end
            65:begin {oRegAddr,oRegData}<={16'h3612, 8'h29}; end
            66:begin {oRegAddr,oRegData}<={16'h3708, 8'h64}; end // 0x3708, 0x64,
            ...
            79:begin {oRegAddr,oRegData}<={OV5640_BLC_CTRL01, 8'h02}; end //0x4001, 0x02, // BLC start from line 2
            80:begin {oRegAddr,oRegData}<={OV5640_BLC_CTRL05, 8'h1a}; end //0x4005, 0x1a, // BLC always update
            81:begin {oRegAddr,oRegData}<={OV5640_SYSREM_RESET00, 8'h00}; end //0x3000, 0x00, // enable blocks
            82:begin {oRegAddr,oRegData}<={OV5640_SYSREM_RESET02, 8'h1c}; end
            83:begin {oRegAddr,oRegData}<={OV5640_CLOCK_ENABLE00, 8'hff}; end // 0x3004, 0xff, // enable clocks
            84:begin {oRegAddr,oRegData}<={OV5640_CLOCK_ENABLE02, 8'hc3}; end
            85:begin {oRegAddr,oRegData}<={OV5640_MIPI_CONTROL00, 8'h58}; end //0x300e, 0x58, // MIPI power down, DVP enable
            86:begin {oRegAddr,oRegData}<={16'h302e, 8'h00}; end // 0x302e, 0x00,
            87:begin {oRegAddr,oRegData}<={OV5640_POLARITY_CTRL, 8'h22}; end
            88:begin {oRegAddr,oRegData}<={OV5640_FORMAT_CTRL00, 8'h30}; end  //0x4300, 0x30, // YUV 422, YUYV
            89:begin {oRegAddr,oRegData}<={OV5640_FORMAT_MUX_CTRL, 8'h00}; end //0x501f, 0x00, // YUV 422
            //001: JPEG mode 1.
            //010: JPEG mode 2.
            //011: JPEG mode 3.
            //100: JPEG mode 4.
            ...
            92:begin {oRegAddr,oRegData}<={16'h440e, 8'h00}; end //0x440e, 0x00,
            ...
            97:begin {oRegAddr,oRegData}<={OV5640_ISP_CONTROL00, 8'ha7}; end //0x5000, 0xa7, // Lenc on, raw gamma on, BPC on, WPC on, CIP on
            ...
            239:begin {oRegAddr,oRegData}<={OV5640_AEC_CTRL0F, 8'h30}; end //0x3a0f, 0x30, // stable range in high
            240:begin {oRegAddr,oRegData}<={OV5640_AEC_CTRL10, 8'h28}; end //0x3a10, 0x28, // stable range in low
            241:begin {oRegAddr,oRegData}<={OV5640_AEC_CTRL1B, 8'h30}; end //0x3a1b, 0x30, // stable range out high
            242:begin {oRegAddr,oRegData}<={OV5640_AEC_CTRL1E, 8'h26}; end //0x3a1e, 0x26, // stable range out low
            243:begin {oRegAddr,oRegData}<={OV5640_AEC_CTRL11, 8'h60}; end //0x3a11, 0x60, // fast zone high
            244:begin {oRegAddr,oRegData}<={OV5640_AEC_CTRL1F, 8'h14}; end //0x3a1f, 0x14, // fast zone low
            ...
            246:begin {oRegAddr,oRegData}<={OV5640_PAD_OUTPUT_ENABLE01, 8'hFF}; end //0x3107=0xFF.
            247:begin {oRegAddr,oRegData}<={OV5640_PAD_OUTPUT_ENABLE02, 8'hFF}; end //0x3108=0xFF.
            ...
            251:begin {oRegAddr,oRegData}<={OV5640_SC_PLL_CONTRL0, 8'h1a}; end //0x3034=0x1a.
            252:begin {oRegAddr,oRegData}<={OV5640_SC_PLL_CONTRL1, 8'h41}; end
            253:begin {oRegAddr,oRegData}<={OV5640_SC_PLL_CONTRL2, 8'h60}; end
            254:begin {oRegAddr,oRegData}<={OV5640_SC_PLL_CONTRL3, 8'h13}; end //0x3037=0x13.
            255:begin {oRegAddr,oRegData}<={OV5640_SYSTEM_ROOT_DIVIDER, 8'h01}; end //0x3108=0x01.
            ...
            //Input 24MHz, 0x3037[3:0]=3, 24MHz/3=8MHz.
            //0x3036[6:0]=0x60=96, 8MHz*96=768MHz.
            //0x3035[7:4]=0x41=0100_xxxx=4, 768MHz/4=192MHz.
            //
            //1600*1200 JPEG Mode.
            263:begin {oRegAddr,oRegData}<={16'h3035, 8'h21}; end // PLL 
            264:begin {oRegAddr,oRegData}<={16'h3036, 8'h69}; end // PLL 
            ///////////////////////////////////////////////////////////////////////////////////
            265:begin {oRegAddr,oRegData}<={16'h3c07, 8'h07}; end // lightmeter 1 threshold[7:0] 
            266:begin {oRegAddr,oRegData}<={16'h3820, 8'h46}; end// flip
            267:begin {oRegAddr,oRegData}<={16'h3821, 8'h20}; end// mirror 
            ...
            278:begin {oRegAddr,oRegData}<={16'h3808, 8'h06}; end// DVPHO 
            279:begin {oRegAddr,oRegData}<={16'h3809, 8'h40}; end// DVPHO 
            280:begin {oRegAddr,oRegData}<={16'h380a, 8'h04}; end// DVPVO 
            281:begin {oRegAddr,oRegData}<={16'h380b, 8'hb0}; end// DVPVO 
            ...
            */
            ...
            289:begin {oRegAddr,oRegData}<={16'h3709, 8'h12}; end
            ...
            //0x30-YUYV,0x31-YVYU,0x33-VYUY,0x32-UYVY.
            291:begin {oRegAddr,oRegData}<={16'h4300, 8'h30};end//0x4300, 0x30, // YUV 422, YUYV
            292:begin {oRegAddr,oRegData}<={16'h501f, 8'h00};end //0x501f, 0x00, // YUV 422 
            ...
            295:begin {oRegAddr,oRegData}<={16'h3006, 8'hff};end // enable clock of JPEG2x, JPEG
            296:begin {oRegAddr,oRegData}<={16'h4713, 8'h01};end // JPEG mode 1
            297:begin {oRegAddr,oRegData}<={16'h4407, 8'h01};end // Quantization sacle 
            ...
            301:begin {oRegAddr,oRegData}<={16'h3824, 8'h02};end // PCLK manual divider
            302:begin {oRegAddr,oRegData}<={16'h5001, 8'hA3};end // SDE on, CMX on, AWB on
            303:begin {oRegAddr,oRegData}<={16'h3503, 8'h00};end
            ...
            //////////////////////////////////////////////////
            // 313: begin {oRegAddr,oRegData}<={16'h3037, 8'h13}; end
            // //PRE_DIV0=0x3037[3:0]=3, 24MHz/3=8Mhz.
            // 314: begin {oRegAddr,oRegData}<={16'h3036, 8'h60}; end
            // //DIV_CNT7B=0x3037[7]=0x3036[7:1]*2:0x3036[6:0].
            // //0x3037[7]=0, 0x3036[6:0]=0x60=96. 8MHz*96=768Mhz.
            // 315: begin {oRegAddr,oRegData}<={16'h3035, 8'h41}; end
            // //SDIV0=0x3035[7:4]=0x4,768MHz/4=192Mhz.
            // 316: begin {oRegAddr,oRegData}<={16'h3034, 8'h18}; end
            // //PLL_RDIV=0x3037[4]=1, 192MHz/2=96Mhz.
            // //BIT_DIV=0x3034[3:0]=0x8 => 2.  96Mhz/2=48MHz.
            // 317: begin {oRegAddr,oRegData}<={16'h3108, 8'h01}; end
            // //PCLK_DIV=0x3108[5:4]=0, 48MHz/1=48MHz.
            // //P_DIV, mipi_lane?r3035[3:0]:2*r3035[3:0]
            // //2*r3035[3:0]=2*1=2,  48Mhz/2=24Mhz.
            // 318: begin {oRegAddr,oRegData}<={16'h3824, 8'h04}; end //12Mhz.
            // //JPG?INT(r3824[4:0]/2):Auto
            // //r3840[4:0]=0x4,   24MHz/(4/2)=12MHz.
            // //318: begin {oRegAddr,oRegData}<={16'h3824, 8'h02}; end //24MHz/(2/2)=24Mhz.
/////////////////////////////////////////////////////////////////////////////
            313: begin {oRegAddr,oRegData}<={16'h3037, 8'h13}; end
            //PRE_DIV0=0x3037[3:0]=3, 24MHz/3=8Mhz.
            314: begin {oRegAddr,oRegData}<={16'h3036, 8'h69}; end
            //DIV_CNT7B=0x3037[7]?0x3036[7:1]*2:0x3036[6:0].
            //0x3037[7]=1, 0x3036[7:1]=52, 8MHz*(52*2)=832Mhz.
            315: begin {oRegAddr,oRegData}<={16'h3035, 8'h21}; end
            //SDIV0=0x3035[7:4]=0x2,832MHz/2=416Mhz.
            316: begin {oRegAddr,oRegData}<={16'h3034, 8'h1a}; end
            //PLL_RDIV=0x3037[4]=1, 416MHz/2=208Mhz.
            //BIT_DIV=0x3034[3:0]=0xA => 2.5   208Mhz/2.5=83.2MHz.
            317: begin {oRegAddr,oRegData}<={16'h3108, 8'h01}; end
            //PCLK_DIV=0x3108[5:4]=0, 83.2MHz/1=83.2MHz.
            //P_DIV, mipi_lane?r3035[3:0]:2*r3035[3:0]
            //2*r3035[3:0]=2*1=2,  83.2Mhz/2=41.6Mhz.
            //318: begin {oRegAddr,oRegData}<={16'h3824, 8'h04}; end //12Mhz.
            //JPG?INT(r3824[4:0]/2):Auto
            //r3840[4:0]=0x2,   41.4MHz/(2/2)=41.4MHz.
            318: begin {oRegAddr,oRegData}<={16'h3824, 8'h02}; end
        default:
