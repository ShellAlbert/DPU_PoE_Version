        ...
        case(iOpReq)
            3'b000: //[2:0]=3'b000, Hardware Reset.
                ...
                `STEP_00: //Pull down RESETB.
                    ...
                    else begin oDVP_PWDN<=1; oDVP_RST<=0; cnt1_i<=cnt1_i+1; end
                `STEP_01: //Pull up RESETB.
                    if(cnt1_i==32768-1) begin cnt1_i<=0; oDVP_RST<=1; step_i<=step_i+1;end
                    else begin oDVP_PWDN<=0; cnt1_i<=cnt1_i+1; end
            ...
            3'b010: //[2:0]=3'b010, Write Registers.
                ...
                `STEP_24: //Stop.
                    if(clk_SCL) begin SDA_Out_i<=1; step_i<=step_i+1; end 
                `STEP_25:
                    if(cnt1_i==16'hFFFF-1) begin cnt1_i<=0; oOpDone<=1; step_i<=step_i+1; end
                    else begin cnt1_i<=cnt1_i+1; end
                `STEP_26:
                    begin oOpDone<=0; step_i<=`STEP_00; end
                default:
